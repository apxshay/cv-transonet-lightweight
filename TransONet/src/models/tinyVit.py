...
class Conv2d_BN(torch.nn.Sequential):
    def __init__(self, a, b, ks=1, stride=1, pad=0, dilation=1,
        ...
        #print('bn weight {}'.format(bn.weight.shape))
...
class PatchEmbed(nn.Module):
    def __init__(self, in_chans, embed_dim, resolution, activation):
        ...
        #print('patches_resolution {}'.format(self.patches_resolution))
...
class BasicLayer(nn.Module):
    ...
    def __init__(self, dim, input_resolution, depth, num_heads, window_size,
        ...
        self.dim = dim
        self.input_resolution = input_resolution
        #print('input_resolution {}'.format(input_resolution))
        self.depth = depth
        self.use_checkpoint = use_checkpoint
...
class TinyViT(nn.Module):
    def __init__(self, img_size=224, in_chans=3, num_classes=1000,
        ...
        #print('patches_resolution {}'.format(patches_resolution))
    ...
    def forward_features(self, x):
        ...
        #print('x after patch: {}'.format(x.shape))
        x = self.layers[0](x)
        start_i = 1
        ...
        for i in range(start_i, len(self.layers)):
            layer = self.layers[i]
            x = layer(x)
            #print('x after layer {}: {}'.format( 1, x.shape))
    ...
    def forward(self, x):
        ...
        x = self.norm_head(x)
        #print('x after norm head: {}'.format(x.shape))
        x = self.head(x)
        #print('x after head: {}'.format(x.shape))
        return x
